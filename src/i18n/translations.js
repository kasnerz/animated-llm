...
const translations = {
  en: {
    ...
    predicted_probability_of: 'Predicted probability of',
    desired_probability_of: 'Desired probability of',
    difference_d: 'Difference (d):',
    model_error_log_d: 'Model error (−log(d)):',
    model_error_log_p: 'Model error (−log(p)):',
    predicted_probabilities_top_tokens: 'Predicted probabilities',
  ...
  cs: {
    ...
    difference: 'Chyba',
    predicted_probability_of: 'Predikovaná pravděpodobnost tokenu',
    desired_probability_of: 'Požadovaná pravděpodobnost tokenu',
    difference_d: 'Rozdíl (d):',
    model_error_log_d: 'Chyba modelu (−log(d)):',
    model_error_log_p: 'Chyba modelu (−log(p)):',
    predicted_probabilities_top_tokens: 'Pravděpodobnosti tokenů',
  ...
  fr: {
    ...
    predicted_probability_of: 'Probabilité prédite de',
    desired_probability_of: 'Probabilité désirée de',
    difference_d: 'Différence (d) :',
    model_error_log_d: 'Erreur du modèle (−log(d)) :',
    model_error_log_p: 'Erreur du modèle (−log(p)) :',
    predicted_probabilities_top_tokens: 'Probabilités prédites',
  ...
  uk: {
    ...
    difference: 'Різниця',
    predicted_probability_of: 'Прогнозована ймовірність токена',
    desired_probability_of: 'Бажана ймовірність токена',
    difference_d: 'Різниця (d):',
    model_error_log_d: 'Помилка моделі (−log(d)):',
    model_error_log_p: 'Помилка моделі (−log(p)):',
    predicted_probabilities_top_tokens: 'Прогнозовані ймовірності',
  ...
  zh: {
    ...
    difference: '差异',
    predicted_probability_of: '预测概率',
    desired_probability_of: '期望概率',
    difference_d: '差异 (d):',
    model_error_log_d: '模型误差 (−log(d)):',
    model_error_log_p: '模型误差 (−log(p)):',
    predicted_probabilities_top_tokens: '预测概率',
