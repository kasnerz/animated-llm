...
export const OUTPUT_SELECTORS = {
  ...
  appendPathArrow: '.append-path-arrow',
  appendTargetTokenPreview: '.append-target-token-preview',
  previewTokenText: '.preview-token-text',
  previewTokenUnderline: '.preview-token-underline',
